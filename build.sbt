...
lazy val resample4sBuild = uri(
  sys.props.getOrElse(
    "alder.resample4s.build",
...
lazy val linop4sRevision = "fec77db060b130b3c609a43d07ff0bfb31088aae"
lazy val linop4sBuild = uri(
  sys.props.getOrElse(
    "alder.linop4s.build",
    s"https://github.com/canardlapin/linops4s.git#$linop4sRevision"
  )
)
